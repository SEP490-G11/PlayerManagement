...
AccountPaymentPopOver.template = "z_invoice.AccountPaymentPopOver";
...
AccountPaymentField.template = "z_invoice.AccountPaymentField";
...
registry.category("fields").add("z_payment", accountPaymentField);
