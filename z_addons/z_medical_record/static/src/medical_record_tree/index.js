...
import { GroupListArchParser, ListArchParser } from "@web/views/list/list_arch_parser";
...
import { treeToastView } from "@z_web/shared/tree_with_toast";

export class AddHeaderName extends ListArchParser {
  parse(xmlDoc, models, modelName) {
    ...
    visitXML(xmlDoc, (node) => {
      ...
      if (node.tagName === "button") {
        ...
        treeAttr.multiEdit = activeActions.edit ? archParseBoolean(node.getAttribute("multi_edit") || "") : false;
...
export class AddHeaderNameRenderer extends ListRenderer {}
AddHeaderNameRenderer.recordRowTemplate = "z_medical_record.ListRenderer.RecordRow";

registry.category("views").add("medical_record_tree", {
  ...treeToastView,
